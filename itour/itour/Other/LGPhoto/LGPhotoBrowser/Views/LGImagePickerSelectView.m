...
- (id)init{
    if (self = [super init]) {
        ...
        [self.backBtn setFrame:CGRectMake(0, 20, 60, 35)];
//        [self.backBtn setImageEdgeInsets:UIEdgeInsetsMake(0, 0, 20, 24)];
        [self.backBtn setImage:GetImage(@"btn_back_imagePicker.png") forState:UIControlStateNormal];
        [self addSubview:self.backBtn];
        
        self.selectBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [self.selectBtn setFrame:CGRectMake(SCREEN_WIDTH - 40 - 10, 25, 30, 30)];
